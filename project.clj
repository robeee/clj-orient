(defproject org.clojars.michaelsbradleyjr/clj-orient "0.4.1-SNAPSHOT"
  :description "Wrapper for the OrientDB Native APIs. It supports version 1.1.0 of the APIs."
  ...
  :jvm-opts ["-Dstorage.keepOpen=true"]
